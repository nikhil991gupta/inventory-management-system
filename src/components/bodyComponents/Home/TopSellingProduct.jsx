...
export default function TopSellingProduct() {
  const products = [
    { name: "Rice", price: 25.05, quantity: 73, amount: 1.828 },
    {
      name: "Salt",
      price: 85.05,
      quantity: 84,
    ...
    { name: "Peanut", price: 96.05, quantity: 94, amount: 9.028 },
    { name: "Mustard", price: 31.09, quantity: 51, amount: 1.585 },
    { name: "Pulses", price: 27.09, quantity: 78, amount: 2.113 },
  ];
  return (
    <Box
      sx={{
